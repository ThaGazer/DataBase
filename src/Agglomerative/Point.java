...
public class Point {
    ...
    /**
     * constructs a Agglomerative.Point where the id is 0 and the time points are all 0.0
     */
    public Point() {
        gID = 0;
    ...
    /**
     * Constructs a Agglomerative.Point with an id and a predefined list of time points
     * @param id id of the Agglomerative.Point
     * @param tPoint time points of the Agglomerative.Point
     */
    ...
    /**
     * gets the id of the Agglomerative.Point
     * @return gID
     */
    public int getID() {
        return gID;
    ...
    /**
     * sets the id of the Agglomerative.Point
     * @param id id to set
     */
    ...
    /**
     * calculates the distance from one Agglomerative.Point to another
     * @param a second Agglomerative.Point for the distance formula
